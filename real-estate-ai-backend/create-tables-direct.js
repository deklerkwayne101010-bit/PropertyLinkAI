...
async function createTables() {
  try {
    ...
    await client.query(`CREATE INDEX IF NOT EXISTS "users_emailVerificationToken_idx" ON "users"("emailVerificationToken")`);
    await client.query(`CREATE INDEX IF NOT EXISTS "users_passwordResetToken_idx" ON "users"("passwordResetToken")`);
    await client.query(`CREATE INDEX IF NOT EXISTS "properties_userId_idx" ON "properties"("userId")`);
    await client.query(`CREATE INDEX IF NOT EXISTS "properties_location_idx" ON "properties"("location")`);
    await client.query(`CREATE INDEX IF NOT EXISTS "properties_propertyType_idx" ON "properties"("propertyType")`);
    await client.query(`CREATE INDEX IF NOT EXISTS "properties_price_idx" ON "properties"("price")`);
    await client.query(`CREATE INDEX IF NOT EXISTS "generated_content_propertyId_idx" ON "generated_content"("propertyId")`);
    await client.query(`CREATE INDEX IF NOT EXISTS "generated_content_cacheKey_idx" ON "generated_content"("cacheKey")`);
